  		...
  		<div class="panel panel-warning">
		   <div class="panel-heading">
		      <h3 class="panel-title">角色菜单分配
		       <span onclick="history.go(-1)" style="color: blue;font-size: 12px;cursor:pointer;">&nbsp;&nbsp;&nbsp;<b>返回</b></span></h3>
		   </div>
		...
		<script type="text/javascript">
			$(function(){
				$(".add_").click(function(){
					...
					//添加
					$.ajax({
						url:'web/permiss/addRoleMenus.do',
						data:{"menuId":menuId,"roleId":"${role}"},
						type:"post",
						success:function(res){
							if(res=="0"){
								alert("此角色已经拥有了这个菜单！无需再次添加！");
							}else if(res=="1"){
								//刷新页面
				...
				$(".remove_").click(function(){
					...
					//添加
					$.ajax({
						url:'web/permiss/removeRoleMenus.do',
						data:{"menuId":menuId,"roleId":"${role}"},
						type:"post",
						success:function(res){
							if(res=="0"){
