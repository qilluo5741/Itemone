...
import com.sharebo.util.push.ErrorCodeEnum;
import com.sharebo.util.push.IOSExtra;
...
public class JPushClientExampleTest {
	...
	private static void testSendByRegId(){
		jpush.sendRegIdMessage("1546564", appKey, masterSecret, "老司机~~~~~~~~","170976fa8a83f73a1ed");
	}
