...
public interface OrderMapper {
	 ...
	 * @return
	 */
	public int valHoursIsExists(Map<String,Object> map);
	/**
	 * 查询星期是否禁用
	 * @param map
	 * @return
	...
	/**
	 * 查询时间规则是否有效：0：不存在 《1:存在
	 * @param map
	 * @return
	 */
	public int valDay(Map<String,Object> map);
	/**
	 * 根据车位id查询星期规则
	 * @param parkid
	 * @return
	 ...
	 * @return
	 */
	public List<String> valOrderTimeIsExistx(Map<String,Object> map);
	/**
	 * 添加订单
	 * @param map
	 * @return
	 ...
	 * @return
	 */
	public int addOrdertime(Map<String, Object> map);
	/**
	 * 删除订单
	 * @param orderid
	 * @return
	 ...
	 * @return
	 */
	public int getchargetypeByParkid(String parkid);
	/**
	 * 查询单价
	 * @param parkid
	 * @return
	 */
	public double getMoneyByparkid(String parkid);
	/**
	 * 验证车位是否存在
	 * @param parkid
	 * @return
	...
	public int pagerbyXuCount(String userid);//总数
	/**
	...
	public int pagerbyGongCount(String parkid);//总数
	/**
	 * 根据userid查询最近的两个订单信息
	 * @param userid
	 * @return
