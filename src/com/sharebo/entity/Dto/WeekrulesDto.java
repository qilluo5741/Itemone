...
public class WeekrulesDto implements  Serializable{
	/**
	 * 
	 */
	...
	public String toString() {
		return "WeekrulesDto [friday_begin=" + friday_begin + ", friday_end="
				+ friday_end + ", monday_begin=" + monday_begin
				+ ", monday_end=" + monday_end + ", parkid=" + parkid
				+ ", saturday_begin=" + saturday_begin + ", saturday_end="
				+ saturday_end + ", sunday_begin=" + sunday_begin
				+ ", sunday_end=" + sunday_end + ", thursday_begin="
				+ thursday_begin + ", thursday_end=" + thursday_end
				+ ", tuesday_begin=" + tuesday_begin + ", tuesday_end="
				+ tuesday_end + ", update_time=" + update_time
				+ ", wednesday_begin=" + wednesday_begin + ", wednesday_end="
				+ wednesday_end + ", weekid=" + weekid + "]";
	}
